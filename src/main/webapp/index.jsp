...
<script type="text/javascript">
	...
	$(function() {
		...
		if (!sessionInfo_userId) {/*目的是，如果已经未登录或登录过时了，那么刷新页面后就跳转到登录窗体*/
...
<body>
	<div id="index_layout">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/layout/north.jsp'" style="height: 38px; overflow: hidden;" class="logo"></div>
		<div data-options="region:'west',href:'${pageContext.request.contextPath}/layout/west.jsp',split:true,iconCls:'house'" title="模块导航" style="width: 170px; overflow: hidden;"></div>
		<div data-options="region:'center'" title="欢迎使用SMS销售管理系统V1.0版" style="overflow: hidden;">
